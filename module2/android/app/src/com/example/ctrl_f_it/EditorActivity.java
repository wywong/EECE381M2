...
import com.example.ctrl_f_it.EditorActivity;
import com.example.ctrl_f_it.MyApplication;
import com.example.ctrl_f_it.R;
import com.example.ctrl_f_it.EditorActivity.SocketConnect;
import com.example.ctrl_f_it.EditorActivity.TCPReadTimerTask;
...
public class EditorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//make the received message boxes uneditable in the GUI.
	...
	public class SocketConnect extends AsyncTask<Void, Void, Socket> {
		...
		protected void onPostExecute(Socket s) {
			MyApplication myApp = (MyApplication) EditorActivity.this
					.getApplication();
			myApp.sock = s;
		}
	}
